...
To get started right away, have a look at our [project tracker](https://github.com/dadwic/craft.js/projects) to check out a list of things that we'd like to work on right now. 

If you are interested in proposing a new feature or have found a bug that you'd like to fix, please file a new [issue](https://github.com/dadwic/craft.js/issues).
...
5. Submit a [pull request](https://github.com/dadwic/craft.js/compare) to merge the changes from your fork :heart: **(If your PR is not linked to an existing issue, then be sure to explain what your PR aims to accomplish)**
